...
<div style="margin: 50px">
    <video id="video" controls preload="auto" width="350px" height="600px" autoplay="autoplay">
        <source src="http://148.70.108.65:8080/video/test.mp4" type="video/mp4">
    </video>
    <h1 id="result">播放情况</h1>
...
<script>
    ...
    vid.ontimeupdate = function() {
        //获取当前的播放时间
        res.innerText="播放："+vid.currentTime;
